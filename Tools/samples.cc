...
namespace AnaSamples
{
    ...
    SampleSet::SampleSet(std::string fDir) : fDir_(fDir)
    {
        ...
        sampleSet_["DYJetsToLL_HT_600toInf"]  = FileSummary(fileDir2 + "DYJetsToLL_M-50_HT-600toInf_Tune4C_13TeV-madgraph-tauola.txt", "stopTreeMaker/AUX", 2.179,  lumi, 4493574, 1.0,  kYellow-7);
        sampleSet_["DYJetsToLL_HT_400to600"]  = FileSummary(fileDir2 + "DYJetsToLL_M-50_HT-400to600_Tune4C_13TeV-madgraph-tauola.txt", "stopTreeMaker/AUX", 6.546,  lumi, 4931372, 1.0,  kYellow-7);
        sampleSet_["DYJetsToLL_HT_200to400"]  = FileSummary(fileDir2 + "DYJetsToLL_M-50_HT-200to400_Tune4C_13TeV-madgraph-tauola.txt", "stopTreeMaker/AUX", 52.24,  lumi, 4666496, 1.0,  kYellow-7);
        sampleSet_["DYJetsToLL_HT_100to200"]  = FileSummary(fileDir2 + "DYJetsToLL_M-50_HT-100to200_Tune4C_13TeV-madgraph-tauola.txt", "stopTreeMaker/AUX", 194.3,  lumi, 4054159, 1.0,  kYellow-7);
