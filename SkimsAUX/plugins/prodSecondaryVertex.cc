...
int primaryVertexIndex_ = 0;
 ...
 for(unsigned int i =0; i<svLVec->size(); i++){
  ...
  iEvent.put(std::move(svPT), "svPT");
  iEvent.put(std::move(svETA), "svETA");
  iEvent.put(std::move(svPhi), "svPhi");
  iEvent.put(std::move(svMass), "svMass");
  iEvent.put(std::move(svNTracks), "svNTracks");
  iEvent.put(std::move(svChi2), "svChi2");
  iEvent.put(std::move(svNDF), "svNDF");
  iEvent.put(std::move(svDXY), "svDXY");
  iEvent.put(std::move(svDXYerr), "svDXYerr");
  iEvent.put(std::move(svD3D), "svD3D");
  iEvent.put(std::move(svD3Derr), "svD3Derr");
  iEvent.put(std::move(svCosThetaSVPS), "svCosThetaSVPS");
  iEvent.put(std::move(svLVec), "svLVec");
  iEvent.put(std::move(svSoftLVec), "svSoftLVec");
