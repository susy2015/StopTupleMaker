...
process.stopTreeMaker = cms.EDProducer("stopTreeMaker",
    ...
    varsDoubleNamesInTree = cms.vstring('prodJetsNoMu:recoJetschargedHadronEnergyFraction|recoJetschargedHadronEnergyFractionMuCleaned', 
        'prodJetsNoMu:recoJetsHadronEnergyFraction|recoJetsHadronEnergyFractionMuCleaned', 
        'prodJetsNoMu:recoJetsneutralEmEnergyFraction|recoJetsneutralEmEnergyFractionMuCleaned', 
    ...
    vectorDouble = cms.VInputTag(cms.InputTag("prodMuonsNoIso","muonsCharge"), cms.InputTag("prodMuonsNoIso","muonsMtw"), cms.InputTag("prodMuonsNoIso","muonsRelIso"), cms.InputTag("prodMuonsNoIso","muonsMiniIso"), cms.InputTag("prodElectronsNoIso","elesCharge"), 
        ...
        cms.InputTag("prodJets","recoJetsneutralEmEnergyFraction"), cms.InputTag("prodJetsNoMu","recoJetschargedHadronEnergyFraction"), cms.InputTag("prodJetsNoMu","recoJetschargedEmEnergyFraction"), cms.InputTag("prodJetsNoMu","recoJetsneutralEmEnergyFraction"), cms.InputTag("prodJets","recoJetschargedEmEnergyFraction"), 
        cms.InputTag("prodJetsNoMu","recoJetschargedEmEnergyFraction"), cms.InputTag("prodJets","recoJetsBtag"), cms.InputTag("prodJetsNoMu","recoJetsBtag"), cms.InputTag("prodIsoTrks","trksForIsoVetocharge"), cms.InputTag("prodIsoTrks","trksForIsoVetodz"), 
        cms.InputTag("prodIsoTrks","looseisoTrkscharge"), cms.InputTag("prodIsoTrks","looseisoTrksdz"), cms.InputTag("prodIsoTrks","looseisoTrksiso"), cms.InputTag("prodIsoTrks","looseisoTrksmtw")),
